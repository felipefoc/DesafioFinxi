...
class TesteTipoUsuario(TestCase):
...
class ModelViewSetTest(APITestCase):
    ...
    def teste_se_anunciante_tem_acesso_apenas_a_propria_demanda(self):
    ...
    def teste_se_anunciante_tem_acesso_a_propria_demanda_especifica(self):
    ...
    def teste_se_anunciante_nao_tem_acesso_a_outras_demandas(self):
    ...
    def testa_criacao_de_demanda(self):
        payload = {
            'descricao': self.peca.pk,
            'endereco_de_entrega': 'Rua Teste, 22, Jardim Botanico',
    ...
    def testa_update_de_demanda(self):
        demanda = {
            'descricao': self.peca,
            'endereco_de_entrega': 'Rua Teste, 22, Jardim Botanico',
            'informacoes_de_contato': '(21)96692-9828',
