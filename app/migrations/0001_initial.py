# Generated by Django 3.2.3 on 2021-05-30 20:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_de_finalizacao', models.BooleanField(choices=[(True, 'Aberto'), (False, 'Fechado')], default=True)),
                ('anunciante', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('descricao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.peca')),
            ],
        ),
    ]
